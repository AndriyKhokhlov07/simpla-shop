<?php /* Smarty version Smarty-3.1.18, created on 2022-04-18 15:40:35
         compiled from "simpla\design\html\product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1561127070625952cad95e26-93346949%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1561127070625952cad95e26-93346949',
  'function' => 
  array (
    'category_select' => 
    array (
  ...
  'unifunc' => 'content_625952cae4c438_77712031',
  'variables' => 
  array (
    'product' => 0,
    'manager' => 0,
...
<?php if ($_valid && !is_callable('content_625952cae4c438_77712031')) {function content_625952cae4c438_77712031($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'C:\\xampp\\htdocs\\simpla\\www\\Smarty\\libs\\plugins\\modifier.replace.php';
if (!is_callable('smarty_modifier_truncate')) include 'C:\\xampp\\htdocs\\simpla\\www\\Smarty\\libs\\plugins\\modifier.truncate.php';
...
$(function() {
	...
	// Добавление варианта
	let variant = $('#new_variant').clone(true);
	...
	let new_related_product = $('#new_related_product').clone(true);
...
"/> 
		...
		<div class="checkbox">
			<input name=bestsellers value="1" type="checkbox" id="bestsellers_checkbox" <?php if ($_smarty_tpl->tpl_vars['product']->value->bestsellers) {?>checked<?php }?>/> <label for="bestsellers_checkbox">Бестселлеры</label>
		</div>
	</div> 
