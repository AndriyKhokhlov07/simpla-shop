...
<input type=hidden name="session_id" value="{$smarty.session.id}">
 	...
 	<div id="name">
		...
		<div class="checkbox">
			<input name=bestsellers value="1" type="checkbox" id="bestsellers_checkbox" {if $product->bestsellers}checked{/if}/> <label for="bestsellers_checkbox">Бестселлеры</label>
		</div>
	</div> 
