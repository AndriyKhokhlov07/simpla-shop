    ...
    function fetch()
    {
       ...
       // print_r($category);
        ...
        if (!empty($related_ids)) {
            $r_products_params['id'] = $related_ids;
        } else {
            $r_products_params['category_id'] = $category->id;

            $r_products_params['not_id'] = $product->id;
            $r_products_params['sort'] = 'rand';
            $r_products_params['limit'] = 3;
            // $r_products_params['echo_query'] = true;
        }

        foreach ($this->products->get_products($r_products_params) as $p)
